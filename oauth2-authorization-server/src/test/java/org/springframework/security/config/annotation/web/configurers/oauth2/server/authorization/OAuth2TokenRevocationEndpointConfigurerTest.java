...
public class OAuth2TokenRevocationEndpointConfigurerTest {
	...
	public void assertionWhenAuthenticationProviderNull() {
		...
		OAuth2TokenRevocationEndpointConfigurer configurer =
				new OAuth2TokenRevocationEndpointConfigurer(opp);
